            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    ...
                    <div className={styles.brandSection}>
                        <h3 className={styles.brandTitle}>Sweet & Salty</h3>
                        <p className={styles.brandDescription}>
                            Teste novas receitas, inovadoras e deliciosas.
                        </p>
                    </div>
                    ...
                    <div className={styles.linksSection}>
                        ...
                        <ul className={styles.linksList}>
                            ...
                            <li><a href="/receitas" className={styles.link}>Receitas</a></li>
                            <li><a href="/usuarios" className={styles.link}>Usuários</a></li>
                ...
                <div className={styles.bottomSection}>
                    <div className={styles.socialIcons}>
                        <a 
                            href="https://github.com/Amandamecchi" 
